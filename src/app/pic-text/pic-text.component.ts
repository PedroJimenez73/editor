...
@Component({
  ...
  styleUrls: ['./pic-text.component.scss']
})
export class PicTextComponent implements OnInit {
  ...
  setCode() {
      let subtitleElem =  this.editorForm.get('h3').value !== '' ?  `<h3 className="subtitle">${this.editorForm.get('h3').value}</h3>`   :  '{/* <h3 className="subtitle"></h3> */}';
